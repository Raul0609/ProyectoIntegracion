...
public class CommentService {
     ...
     */
    public List<CommentDTO> fetchComments(String owner, String repo, String issueNumber) {
     ...
     */
    public List<Comment> processComments(String owner, String repo, String issueId) {
