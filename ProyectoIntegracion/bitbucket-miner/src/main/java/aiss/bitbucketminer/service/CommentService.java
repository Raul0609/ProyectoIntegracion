...
public class CommentService {
     ...
     */
    public List<CommentDTO> fetchComments(String workspace, String repoSlug, int issueId) {
     ...
     */
    public List<Comment> processComments(String workspace, String repoSlug, int issueId) {
